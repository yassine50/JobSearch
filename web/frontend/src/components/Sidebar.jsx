...
import { LayoutDashboard, Search, Users, Bookmark, LogOut } from 'lucide-react'
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-60 bg-slate-800 border-r border-slate-700 flex flex-col py-6 px-3 fixed h-full z-10">
